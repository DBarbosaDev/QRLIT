...
AGENT_CSV_FILE = f'{PROJECT_DIR}/data/classic_agent_history/agent_history_sf{SCALE_FACTOR_BASE_UNIT_MB * SCALE_FACTOR}_25epi.csv'
WEIGHTS_FILE = f'{PROJECT_DIR}/data/classic_agent_history/weights_sf{SCALE_FACTOR_BASE_UNIT_MB * SCALE_FACTOR}_25epi.csv'
